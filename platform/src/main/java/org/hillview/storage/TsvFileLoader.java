...
/**
 * Knows how to read a TSV file (comma-separated file).
 */
public class TsvFileLoader extends TextFileLoader {
    ...
    public TsvFileLoader(String path, Config configuration, @Nullable String schemaPath) {
        super(path);
    ...
    public void prepareLoading() {
        ...
        this.reader = new TsvParser(settings);
        ...
        if (this.actualSchema == null) {
            ...
            if (this.firstLine == null)
                throw new RuntimeException("Cannot create schema from empty TSV file");
